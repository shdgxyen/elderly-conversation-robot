...
项目已在真实硬件 **微雪 ESP32-S3-Touch-AMOLED-1.43C** 上运行：动态表情、串口协议与心跳、板载麦克风和喇叭均已实机验证。语音识别、语音合成和人脸识别仍在开发中，树莓派端目前以文本对话联调。
...
- **已在软件完成**：后端文本对话闭环与持久化，可选通义千问 / Kimi 单轮文本回复；
- **尚未完成**：树莓派与终端之间的完整语音对话（真实语音识别、语音合成与音频传输）、人脸识别、长期记忆与自传生成。
